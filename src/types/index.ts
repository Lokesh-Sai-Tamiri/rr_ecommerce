...
// Import all override declarations to ensure they're loaded
import './overrides/Alert';
import './overrides/Button';
import './overrides/Chip';
import './overrides/createPalette';

// Check if these files exist and add them if they do:
import './overrides/Typography';
import './overrides/createTheme';
import './overrides/createTypography';
import './overrides/DataGrid';
