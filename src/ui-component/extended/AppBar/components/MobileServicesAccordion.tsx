/**
 * @fileoverview Mobile services accordion component for drawer navigation
 */
...
export default function MobileServicesAccordion({ dropdownItems, onItemClick }: MobileServicesAccordionProps) {
  ...
  const isServicesActive = dropdownItems.some((item) => isActiveItem(item.href));
  ...
  return (
    ...
    >
      <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="services-panel-content" id="services-panel-header">
                 <Typography
           variant="h6"
           sx={{
             fontSize: '1rem',
         ...
         >
          <FormattedMessage id="navigation.mobile.services" defaultMessage="Services" />
        </Typography>
      </AccordionSummary>
      <AccordionDetails>
