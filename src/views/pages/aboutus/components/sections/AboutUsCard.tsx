/**
 * @fileoverview About Us Card Component with proper TypeScript types
 */
...
import { useScreenDetection, FONT_WEIGHTS, LINE_HEIGHTS } from '../../../landing/utils';
...
export const AboutUsCard = React.memo<AboutCardProps>(({ section, index, fontSizes, getCardStyles }) => {
